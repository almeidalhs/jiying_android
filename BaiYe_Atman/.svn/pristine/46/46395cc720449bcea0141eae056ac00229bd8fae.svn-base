...
public class YLBDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    public YLBDefaultHeader(Context context) {
        super(context);
        initViews(null);
    }

    public YLBDefaultHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public YLBDefaultHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.refresh_cube_ptr_classic_default_header, this);

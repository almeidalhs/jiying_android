...
public class ViewUtils {
    ...
    public static StateListDrawable getSelector(int resDefault, int resFocus) {
        Drawable resDefaultDrawable = BaseApplication.getContext().getResources().getDrawable(resDefault);
        resDefaultDrawable.setBounds(0, 0, resDefaultDrawable.getMinimumWidth(),
                resDefaultDrawable.getMinimumHeight());
        Drawable resFocusDrawable = BaseApplication.getContext().getResources().getDrawable(resFocus);

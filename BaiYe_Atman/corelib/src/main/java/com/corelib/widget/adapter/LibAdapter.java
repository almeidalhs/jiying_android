 ...
 */
package com.corelib.widget.adapter;
 ...
 * @author vftour.com
 */
public abstract class LibAdapter<T> extends BaseAdapter implements
    ...
    public LibAdapter(AbsListView view, Collection<T> mDatas, int itemLayoutId) {
        if (mDatas == null) {

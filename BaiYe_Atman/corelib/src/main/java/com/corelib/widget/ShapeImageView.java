...
public class ShapeImageView extends ImageView {
    ...
    private void init(AttributeSet attrs) {
        ...
        mRoundRadius = a.getDimension(R.styleable.ShapeImageView_shape_round_radius, mRoundRadius);
        mBorderSize = a.getDimension(R.styleable.ShapeImageView_shape_border_size, mBorderSize);
        mBorderColor = a.getColor(R.styleable.ShapeImageView_shape_border_color, mBorderColor);
        a.recycle();
    }

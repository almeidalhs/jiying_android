...
package com.atman.jishang.widget.dateselect.wheel.widget;
...
public class WheelView extends View {
	 ...
	 */
	private static int ADDITIONAL_ITEM_HEIGHT = 50;
	 ...
	 */
	private static int ITEM_OFFSET = TEXT_SIZE / 7;
	...
	private void initData(Context context) {
		ADDITIONAL_ITEM_HEIGHT = dip2px(context,15);

...
public class NewsListAdapter extends BaseAdapter {
    ...
    public NewsListAdapter(Context context, ImageLoader mImageLoader) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.item_newslist, null);
        ...
        mImageLoader.get(mBodyEntity.getFullTitleImage(),
                new DefaultImageListener(holder.itemNewslistIc, com.atman.jishang.R.mipmap.ic_launcher));

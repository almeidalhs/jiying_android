 ...
 * 电话 18578909061
 */
public class GridEditAdapter extends BaseAdapter {
    ...
    public GridEditAdapter(Context context) {
        this.context = context;
        inflater = LayoutInflater.from(context);
    }

    public GridEditAdapter(Context context, ImageLoader mImageLoader) {
        this.context = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == Bimp.bmp.size()) {
            ...
            if (Bimp.bmp.get(position)==null) {
                if (Bimp.drr.get(position).startsWith("http") || Bimp.drr.get(position).startsWith("goods") ) {

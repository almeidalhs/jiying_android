...
public class FileUtils {
    ...
    public String readFromAsset(String fileName) {
        ...
        try {
            is = BaiYeBaseApplication.getApp().getAssets().open(fileName);
    ...
    public boolean saveBmpToFolder(int packageId, String stickerUrl) {
        ...
        try {
            ...
            if (stickerUrl.startsWith("http://") || stickerUrl.startsWith("https://")) {
                ...
                inputStream = BaiYeBaseApplication.getApp().getAssets().open("preinstall/" + stickerUrl);
            }
            createFile(file);
    ...
    private FileUtils() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(sdcardState)) {
            ...
            BASE_PATH = BaiYeBaseApplication.getApp().getCacheDirPath();
        }
    ...
    public File getCacheDir() {
        return BaiYeBaseApplication.getApp().getCacheDir();
    }

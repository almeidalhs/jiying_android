 ...
 */
public class ShopTypeAdapter extends AbstractWheelTextAdapter {
    List<IndustryTypeModel.BodyEntity> list;
    WheelView mSchoolWheel;
    Context context;

    public void setList(List<IndustryTypeModel.BodyEntity> list) {
        this.list = list;
        notifyDataChangedEvent();
    }

    public ShopTypeAdapter(Context context, WheelView mSchoolWheel, List<IndustryTypeModel.BodyEntity> list
    ...
    public CharSequence getItemText(int index) {
        return list.get(index).getScName() + "";
    }
}
